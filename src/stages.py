...
def stage_2(
    ...
    # stage_2_2(input_file=outline_file, llm_model=llm_model, output_file=summary_file)
...
def stage_2_2(input_file: str, llm_model: str, output_file: str) -> None:
    logger.info(f"{datetime.now()}:Stage 2-2: Formatting Summary File")
    format_summary_file(
        input_file=input_file, llm_model=llm_model, output_file=output_file
    )
